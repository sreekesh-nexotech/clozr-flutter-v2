...
class Routes {
  ...
  static const Map<String, RouteMeta> meta = {
    ...
    members: RouteMeta(NavContext.crm, true),
    memberDetail: RouteMeta(NavContext.crm, false),
    teams: RouteMeta(NavContext.crm, true),
    roles: RouteMeta(NavContext.crm, true),
